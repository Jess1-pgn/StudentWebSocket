...
public class StudentDAO {
    ...
    public List<Student> getAllStudents() {
        ...
        String sql = "SELECT idStudent, firstNameStudent, lastNameStudent, dateBirthStudent FROM students ORDER BY idStudent";
    ...
    public Student getStudentById(int id) {
        String sql = "SELECT idStudent, firstNameStudent, lastNameStudent, dateBirthStudent FROM students WHERE idStudent = ?";
